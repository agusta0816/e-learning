...
class Msg_model extends CI_Model
{
     ...
     * @return integer
     */
    public function count($type_id=0, $owner_id=0, $type_get=null)
    {
        switch ($type_get) {
            case 'unread':
     ...
     * @return array
     */
    public function retrieve($owner_id=0, $id=0, $old_related_msg = true, $new_related_msg = true)
    {
        $this->db->where('owner_id', $owner_id);
        $this->db->where('id', $id);
     ...
     * @return array
     */
    public function retrieve_all($no_of_records = 10, $page_no = 1, $owner_id=0, $search = array(), $pagination = true)
    {
        $where             = array();
        $group_by          = array();
